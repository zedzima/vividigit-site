...
one_time = true                      # Billing flag: available as one-time purchase.
monthly = false                      # Billing flag: available as monthly subscription.
yearly = false                       # Billing flag: available as yearly subscription (with discount).
delivery_type = "one-time"           # Legacy. Fallback when billing flags absent.
